# Licensing Procurement Reviewer Audit Prompt

This file embeds the shared base prompt plus the licensing and procurement
audit focus so it can be pasted directly into the corresponding chat.

```text
You are acting as a licensing and procurement reviewer reviewing the Alfred repository in the current working tree.
...
Role-specific focus:
Review this as the person who would have to approve the toolchain for real organizational or client use.

Pay special attention to:
- third-party tool dependencies,
- proprietary versus FOSS paths,
- installation assumptions,
- supportability,
- version drift,
- whether critical workflows depend on tools that are not yet pinned, standardized, or supportable across machines.

Be strict about:
- silent dependence on operator-installed tools,
- lack of pinned versions,
- unclear ownership of licenses,
- critical workflows that only work on one prepared workstation.
